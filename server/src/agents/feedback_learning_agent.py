...
class FeedbackLearningAgent(BaseAgent):
    ...
    def __init__(self):
        ...
        """
        super().__init__()
        self.feedback_prompt = FileUtils.read_file_content("src/prompts/v1/feedback_learning_agent.md")
    ...
    async def analyze_feedback(
        ...
        input_data = {
            ...
            "task_above": {
                ...
                "relevance_score": task_above.get("relevance_score") if task_above else None
            },
            "task_below": {
                "id": task_below.get("task_id") if task_below else None,
                "description": task_below.get("description") if task_below else None,
                "relevance_score": task_below.get("relevance_score") if task_below else None
            },
            "direction": direction,
